...
if authentication_status:
    ...
    if uploaded_file:
        ...
        with tab1:
            ...
            c4.metric("Numeric columns", len(num_cols))
        ...
        with tab4:
            ...
            suggestions.append("Give me a summary of key insights from this data")
            cols = st.columns(3)
            clicked = None
            ...
            if query:
                ...
                st.markdown(result)
                if any(w in query.lower() for w in ["chart", "plot", "graph", "visualize", "bar", "line", "pie"]):
                    if num_cols:
                        st.subheader("📈 Auto-generated chart")
                        st.bar_chart(df[num_cols[:3]])
                chart_path = None
